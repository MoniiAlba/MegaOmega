 ...
 * 
 */
@WebServiceClient(name = "DataBaseService", targetNamespace = "http://wssdatabase/", wsdlLocation = "http://localhost:8080/DataBaseService/DataBaseService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DATABASESERVICE_QNAME = new QName("http://wssdatabase/", "DataBaseService");
    ...
    public DataBaseService getDataBaseServicePort() {
        return super.getPort(new QName("http://wssdatabase/", "DataBaseServicePort"), DataBaseService.class);
    }
    ...
    public DataBaseService getDataBaseServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wssdatabase/", "DataBaseServicePort"), DataBaseService.class, features);
    }
